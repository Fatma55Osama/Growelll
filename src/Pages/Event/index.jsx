  ...
  return (
    <div className='col-12 parentspage'>
      ...
      <div className='col-12  div1page '>
        ...
        <div className='col-10 container col-lg-8 divresearsh   '>
          <div className='col-12  d-flex flex-wrap flex-row justify-content-between' >
            <span className='d-flex align-items-center gap-1'><Link className='nav-link' to={"/"}>Home</Link><HiMiniSlash /> <Link to={"/Event"} className='nav-link'>Event</Link></span>
          ...
          <div className='col-12   div2page d-flex flex-column gap-5'>
            <h3>Events</h3>
            <div className='col-11 col-lg-12 col-md-12 container divcard d-flex justify-content-between flex-wrap gap-4 gap-md-3 gap-lg-4'>
              {
                events?.map((el, index) => {
                  return (
      ...
      <div className='divbooks col-12 d-flex justify-content-center'>
        <div className='col-10 col-lg-8 '>
          <div className='col-12 container col-lg-12 col-md-12 mt-5 mb-5 divcard d-flex justify-content-between flex-wrap gap-4 gap-lg-4'>
            {
              books?.map((el, index) =>
              (
                <div className="card card1 d-flex flex-column justify-content-center align-items-center cardimg" style={{ width: "18rem" }} key={index}>
